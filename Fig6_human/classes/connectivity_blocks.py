...
class SpinesCount:
    ...
    def __init__(self, modelparams, con_params):
        ...
        self._spines_transformation(-self.spines_t1t2)
...
class GaussianConnectivity:
    ...
    def random_projections(self, ind_post, ind_pre, syn_w=True):
        ...
        if i == j:
            ...
            amp = self.amp_lr 
        if syn_w == False: #just returning the amplitude synaptic weights
            return amp
        else:
