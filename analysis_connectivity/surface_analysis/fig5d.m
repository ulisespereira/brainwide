...
load surface_files/Fig6/overlaps_fpn_dan_dmn.mat
load surface_files/Fig6/mean_rate_fpn_dan_dmn.mat
...
for current_parcel = 1:num_areas
    ...
    overlap_map.cdata(vertices_in_parcel,current_time) = overlaps_fpn_dan_dmn(recording_times(current_time),current_parcel, 2);
    rate_map.cdata(vertices_in_parcel,current_time) = rate_fpn_dan_dmn(current_parcel, recording_times(current_time));
end
