...
load surface_files/Fig3/areas_surface_fpn_WM.mat
...
for current_parcel = 1:num_areas
   ...
   rate_map.cdata(vertices_in_parcel,current_time) = areas_surface_fpn_wm(1,current_parcel);
end



fig = plot(l_inflated, rate_map);
colormap([1.0 1.0 1.0;0.87, 0.14, 0.16]); %auditory
clim([0, 0.45])
material([0.3, 0.6, 0])
%colormapeditor